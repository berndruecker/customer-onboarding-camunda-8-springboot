...
public class TwitterAdapter {
    ...
    @ZeebeWorker(type="twitter")
    public Status publishTweet(@ZeebeVariablesAsType TwitterInput input) throws TwitterException {
        ...
        //tweetInput.tweetContent = input.getTweetContent() + "...";
